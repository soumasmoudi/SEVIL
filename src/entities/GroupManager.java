...
public class GroupManager {
	...
	private final DatabaseTA database; // Global Public Parameters
	...
	public GroupManager(TrustedAuthority ta) { // represent the Setup_SGr algorithm
	...
	/** Join_SGr Algorithm STEPs 11 to17 **/

	public DatabaseSigner join_SGr(Vector pkp) {
		...
		DatabaseSigner dbSigner = new DatabaseSigner(rho1, rho2, tau1, tau2, zeta1, zeta2, z1, z2, op);
